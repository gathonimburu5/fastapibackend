...
@employee_router.get("/employees/{employee_id}", response_model=EmployeeOut, dependencies=[Depends(get_current_user)])
...
@employee_router.put("/employees/{employee_id}", response_model=EmployeeOut, dependencies=[Depends(get_current_user)])
...
@employee_router.delete("/employees/{employee_id}", dependencies=[Depends(get_current_user)])
